...
async function main() {
  ...
  const BTC = ["0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f", 8, "0.000377"];
  const ETH = ["0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", 18, "0.008138"];
  const LINK = ["0xf97f4df75117a78c1A5a0DBb814Af92458539FB4", 18, "0.092296"];
  const UNI = ["0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0", 18, "0.094095"];
  const ARB = ["0x912CE59144191C1204E64559FE8253a0e49E6548", 18, "0.418137"];
  const BNB = ["0x7AF00405916D823eDb1121546EfA6F4972B51b84", 18, "0.023199"];
  const SOL = ["0x2bcC6D6CdBbDC0a4071e48bb3B969b06B3330c07", 9, "0.070566"];
  const AVAX = ["0x565609fAF65B92F7be02468acF86f8979423e514", 18, "0.060174"];
  const MATIC = ["0x3ab0E28C3F56616aD7061b4db38aE337E3809AEA", 18, "1.564874"];
  const APT = ["0x4EdeF400eDe5309240814b5FC403F224504604e9", 8, "0.068363"];
  const TON = ["0x425AC12bb19070901C0CDE873Fc5299cbD7f23D4", 9, "0.546284"];
  const NEAR = ["0x795818DAE0D32E2cf0B1C56ac73B9f5d80D2176c", 24, "0.169397"];
  const SHIB = [
    "0x5033833c9fe8B9d3E09EEd2f73d2aaF7E3872fd1",
    18,
    "92633.33282",
  ];
  const RNDR = ["0xC8a4EeA31E9B6b61c406DF013DD4FEc76f21E279", 18, "0.061107"];
  const DOGE = ["0xd99528Df88172a68E9caCD7Cd4c2712Eb80Dab1E", 8, "22.55715"];
  const ADA = ["0x5A01d64Ee1d9E350DC0Fa2443872bc814d2b14B8", 18, "5.579993"];
  const TRX = ["0x29A1DBE8c32C0ceB1eB92722afb9B231b6F6fdDA", 6, "13.882054"];
  const DOT = ["0x8DC6E5Bfdb369Ea61Aa00666d8a0cB922716A819", 18, "0.225954"];
  const LTC = ["0x9586De8f0F7384CBC12b0ffd3B0d4c12C12871C4", 18, "0.011719"];
  const FIL = ["0xd7F78263CF1A40ab5710725974B7eD6d6A99f4c5", 18, "0.087055"];
